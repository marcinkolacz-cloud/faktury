  ...
  return (
    <div className="grid grid-cols-3 gap-4">
      <div className="bg-white border border-gray-200 rounded-lg p-4 shadow-sm">
        ...
        <p className="font-mono font-bold text-2xl text-gray-900 mt-1">{totalReceived.toFixed(2)} PLN</p>
      </div>
      <div className="bg-white border border-gray-200 rounded-lg p-4 shadow-sm">
        <p className="text-gray-500 text-xs uppercase tracking-wide">Wydano razem</p>
        <p className="font-mono font-bold text-2xl text-gray-900 mt-1">{totalSpent.toFixed(2)} PLN</p>
      </div>
      <div className="bg-white border border-gray-200 rounded-lg p-4 shadow-sm">
